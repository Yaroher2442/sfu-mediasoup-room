...
class Layer {
    ...
    createRouter(worker) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield worker.createRouter({ mediaCodecs });
        });
    }
    createAudioObserver(router) {
        return __awaiter(this, void 0, void 0, function* () {
            let audioLevelObserver = yield router.createAudioLevelObserver({
                interval: 800
            });
    ...
    startLayer() {
        return __awaiter(this, void 0, void 0, function* () {
            this.worker = yield this.createWorker();
            this.router = yield this.createRouter(this.worker);
            this.audioLevelObserver = yield this.createAudioObserver(this.router);
        });
    }
    setTimedTask() {
        setInterval(() => {
    ...
    updatePeerStats() {
        return __awaiter(this, void 0, void 0, function* () {
            for (let producer of this.producers) {
                ...
                try {
                    let stats = yield producer.getStats(), peerId = producer.appData.peerId;
            ...
            for (let consumer of this.consumers) {
                try {
                    let stats = (yield consumer.getStats())
